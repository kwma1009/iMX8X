...
static int mt9p031_power_on(struct mt9p031 *mt9p031)
{
	...
	/* Ensure that there is enough time for the supplies to turn on */
...
/*
 * Although this routine does nothing, it needs to exist as the ISI driver's
 * mxc_md_create_links() calls the link_setup routine fall all sources
 * and sinks.  mxc_md_create_links() fails if any source/sink does not have
 * a link_setup routine.
 */
static int mt9p031_link_setup(struct media_entity *entity,
...
static const struct media_entity_operations mt9p031_subdev_media_ops = {
	.link_setup = mt9p031_link_setup,
};
			 ...
			 const struct i2c_device_id *did)
{
	...
	mt9p031->subdev.entity.ops = &mt9p031_subdev_media_ops;
...
static const struct i2c_device_id mt9p031_id[] = {
	{ "mt9p001", MT9P031_MODEL_COLOR },
	{ "mt9p001m", MT9P031_MODEL_MONOCHROME },
	{ "mt9p006", MT9P031_MODEL_COLOR },
	{ "mt9p006m", MT9P031_MODEL_MONOCHROME },
...
static const struct of_device_id mt9p031_of_match[] = {
	{ .compatible = "aptina,mt9p001", },
	{ .compatible = "aptina,mt9p001m", },
	{ .compatible = "aptina,mt9p006", },
	{ .compatible = "aptina,mt9p006m", },
