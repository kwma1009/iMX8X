...
static int dp83867_of_init(struct phy_device *phydev)
{
	...
	dp83867->led_0_active_low = ofnode_read_bool(node, "ti,led-0-active-low");

	dp83867->led_2_active_low = ofnode_read_bool(node, "ti,led-2-active-low");
...
static int dp83867_config(struct phy_device *phydev)
{
	...
	if (dp83867->led_0_active_low) {
		val = phy_read(phydev, phydev->addr, DP83867_LEDCR2);
		val &= ~DP83867_LEDCR2_LED_0_POLARITY;
		phy_write(phydev, MDIO_DEVAD_NONE, DP83867_LEDCR2, val);
	}
